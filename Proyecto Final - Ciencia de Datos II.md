...
2. scikit-learn. *IsolationForest API*. Referencia independiente de implementación y convención de score. [Documentación oficial](https://scikit-learn.org/stable/modules/generated/sklearn.ensemble.IsolationForest.html). La ejecución local usa 1.7.2.
